...
options.output    = 'mycasanalyzerlooseskim2010.root'
...
process.dca02 = cms.EDAnalyzer('CascadeAnalyzer',
...
process.dca05 = cms.EDAnalyzer('CascadeAnalyzer',
    VeeAlgo       = cms.string('looseV0Candidates'),
...
process.dca1 = cms.EDAnalyzer('CascadeAnalyzer',
    VeeAlgo       = cms.string('looseV0Candidates'),
...
process.dca2 = cms.EDAnalyzer('CascadeAnalyzer',
    VeeAlgo       = cms.string('looseV0Candidates'),
...
process.dca5 = cms.EDAnalyzer('CascadeAnalyzer',
    VeeAlgo       = cms.string('looseV0Candidates'),
...
process.dca1fitvtx = cms.EDAnalyzer('CascadeAnalyzer',
    VeeAlgo       = cms.string('looseV0Candidates'),
    CasAlgo       = cms.string('CascCandidatesDCA1fitvtx'),
    CasDecayName  = cms.untracked.string('Cascade'),
    trackingAlgo  = cms.InputTag('generalTracks')
)
process.dca2fitvtx = cms.EDAnalyzer('CascadeAnalyzer',
    VeeAlgo       = cms.string('looseV0Candidates'),
    CasAlgo       = cms.string('CascCandidatesDCA2fitvtx'),
    CasDecayName  = cms.untracked.string('Cascade'),
    trackingAlgo  = cms.InputTag('generalTracks')
)
process.dca5fitvtx = cms.EDAnalyzer('CascadeAnalyzer',
    VeeAlgo       = cms.string('looseV0Candidates'),
    CasAlgo       = cms.string('CascCandidatesDCA5fitvtx'),
    CasDecayName  = cms.untracked.string('Cascade'),
    trackingAlgo  = cms.InputTag('generalTracks')
)
process.dca02fit2 = cms.EDAnalyzer('CascadeAnalyzer',
    VeeAlgo       = cms.string('looseV0Candidates'),
    CasAlgo       = cms.string('CascCandidatesDCA02fit2'),
    CasDecayName  = cms.untracked.string('Cascade'),
    trackingAlgo  = cms.InputTag('generalTracks')
)
process.dca1fit2 = cms.EDAnalyzer('CascadeAnalyzer',
    VeeAlgo       = cms.string('looseV0Candidates'),
    CasAlgo       = cms.string('CascCandidatesDCA1fit2'),
    CasDecayName  = cms.untracked.string('Cascade'),
    trackingAlgo  = cms.InputTag('generalTracks')
)
process.dca2fit2 = cms.EDAnalyzer('CascadeAnalyzer',
    VeeAlgo       = cms.string('looseV0Candidates'),
    CasAlgo       = cms.string('CascCandidatesDCA2fit2'),
    CasDecayName  = cms.untracked.string('Cascade'),
    trackingAlgo  = cms.InputTag('generalTracks')
)
process.dca5fit2 = cms.EDAnalyzer('CascadeAnalyzer',
    VeeAlgo       = cms.string('looseV0Candidates'),
    CasAlgo       = cms.string('CascCandidatesDCA5fit2'),
    CasDecayName  = cms.untracked.string('Cascade'),
    trackingAlgo  = cms.InputTag('generalTracks')
)
process.dca10fit2 = cms.EDAnalyzer('CascadeAnalyzer',
    VeeAlgo       = cms.string('looseV0Candidates'),
    CasAlgo       = cms.string('CascCandidatesDCA10fit2'),
    CasDecayName  = cms.untracked.string('Cascade'),
    trackingAlgo  = cms.InputTag('generalTracks')
)
process.dca1fit2rebin = cms.EDAnalyzer('CascadeAnalyzer',
    nbins         = cms.untracked.int32(40),
    xmin          = cms.untracked.double(1.255),
    xmax          = cms.untracked.double(1.455),
    VeeAlgo       = cms.string('looseV0Candidates'),
    CasAlgo       = cms.string('CascCandidatesDCA1fit2'),
    CasDecayName  = cms.untracked.string('Cascade'),
    trackingAlgo  = cms.InputTag('generalTracks')
)
process.dca2fit2rebin = cms.EDAnalyzer('CascadeAnalyzer',
    nbins         = cms.untracked.int32(40),
    xmin          = cms.untracked.double(1.255),
    xmax          = cms.untracked.double(1.455),
    VeeAlgo       = cms.string('looseV0Candidates'),
...
process.dca5fit2rebin = cms.EDAnalyzer('CascadeAnalyzer',
    nbins         = cms.untracked.int32(40),
    xmin          = cms.untracked.double(1.255),
    xmax          = cms.untracked.double(1.455),
    VeeAlgo       = cms.string('looseV0Candidates'),
...
process.odca2 = cms.EDAnalyzer('CascadeAnalyzer',
...
process.odca5 = cms.EDAnalyzer('CascadeAnalyzer',
    xmin          = cms.untracked.double(1.62),
    xmax          = cms.untracked.double(1.72),
    VeeAlgo       = cms.string('looseV0Candidates'),
    CasAlgo       = cms.string('CascCandidatesDCA5'),
...
process.odca2fit2 = cms.EDAnalyzer('CascadeAnalyzer',
    xmin          = cms.untracked.double(1.62),
    xmax          = cms.untracked.double(1.72),
    VeeAlgo       = cms.string('looseV0Candidates'),
    CasAlgo       = cms.string('CascCandidatesDCA2fit2'),
...
process.p = cms.Path(process.dca2 + process.dca2fit2 + process.dca2fitvtx
+ process.dca1 + process.dca1fit2 + process.dca1fitvtx
+ process.dca5 +process.dca5fitvtx + process.dca5fit2
+ process.dca1fit2rebin
+ process.dca2fit2rebin
+ process.dca5fit2rebin
